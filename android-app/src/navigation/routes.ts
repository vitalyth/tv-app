...
export const routes: readonly RouteDefinition[] = [
  ...
  },
  {
    ...
    label: 'Series',
    shortLabel: 'SER',
    eyebrow: 'Watch TV shows',
    title: 'Series and seasons',
    description:
      'Discover full seasons, drama series, comedies, and documentaries.',
  },
  {
    id: 'movies',
    label: 'Movies',
    ...
    description: 'Explore on-demand cinema, premieres, and blockbusters.',
  },
  {
    id: 'search',
    label: 'Search',
